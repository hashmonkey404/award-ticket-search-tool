...
class Searcher():
    ...
    def get_market_token(self, ori: str, des: str, date: str):
        headers = {
            ...
            # "authorization": "AWS4-HMAC-SHA256 Credential=ASIAWBHE22QVGJWXJAHV/20230314/us-east-2/execute-api/aws4_request, SignedHeaders=host;x-amz-date;x-amz-security-token, Signature=755d1657795486f098fc76cce7801fafbafc0983efc883ce68ae7bac1ae03faa",
            "cache-control": "no-cache",
